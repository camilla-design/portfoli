    ...
    <article className='flex flex-col rounded-lg items-center space-y-2 flex-shrink-0 w-[400px] md:w-[600px] xl:w-[800px] snap-center bg-gray-50/90 p-5 hover:opacity-100 opacity-70 cursor-pointer transition-opacity duration-200 overflow-hidden'>
        ...
        viewport={{
         ...
         <div className='px-0 md:px-5 text-black'>
             ...
             <p className='w-[300px] md:w-[300px] xl:w-[500px] text-sm md:text-base'> "Explore Leka har brukt Camilla Reppen til produksjon av hjemmeside og logo, og sitter igjen med både gode produkter og gode opplevelser. Camilla loset oss kompetent, kreativt og engasjert gjennom prosessen fra ide til ferdig produkt. Gjennom å bruke tid på å bli kjent med oss, vårt firma og hva vi ønsker å formidle, samhandlet Camilla oss på en god og trygg måte for å finne gode ideer og løsninger. Jobber raskt, er positiv og løsningsorientert. Kan trygt anbefales!"</p>
         </div>
    </article>
  )
}
